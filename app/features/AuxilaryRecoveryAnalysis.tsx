...
const auxPlantLineGroups: Record<string, string[]> = {
  ...
  AAC3: [
    "MP-AUX-CRS-AAC3",
    "MP-AUX-CRS-AACS-AAC3",
    "MP-REC-CRS-AAC3",
  ],

  AAC4: [
    "MP-AUX-CRS-AAC4",
    "MP-AUX-CRS-AACS-AAC4",
  ],

  AAC5: [
    "MP-AUX-CRS-AACS-AAC5",
  ],

  AAC6: [
    "MP-AUX-CRS-AACS-AAC6",
  ],

  AAC7: [
    "MP-AUX-CRS-AACS-AAC7",
  ],

  AAC8: [
    "MP-AUX-CRS-AACS-AAC8",
  ],
  ...
  TEES: [
    "MP-AUX-L01-SALT-TEES",
    "MP-AUX-L02-SALT-TEES",
  ],

  TEE1: [
    "MP-AUX-L03-SALT-TEE1",
  ],

  TEE2: [
    "MP-AUX-L03-SALT-TEE2",
  ],

  TEE3: [
    "MP-AUX-L04-SALT-TEE3",
  ],
  ...
  // =========================
  CAL1: [
    "MP-AUX-CAL-ANHE-CAL1",
  ],

  CAL2: [
    "MP-AUX-CAL-ANHE-CAL2",
  ],

  CAL3: [
    "MP-AUX-CAL-ANHE-CAL3",
  ],

  CAL4: [
    "MP-AUX-CAL-ANHE-CAL4",
  ],

  CAL5: [
    "MP-AUX-CAL-ANHE-CAL5",
  ],

  CAL6: [
    "MP-AUX-CAL-ANHE-CAL6",
  ],
  ...
  // =========================
  MSF1: [
    "MP-AUX-L01-MSFE-MSF1",
    "MP-AUX-L05-MSFE-MSF1",
    "MP-REC-EVA-MSFE-MSF1",
  ],
  ...
  MSF4: [
    ...
    "MP-REC-EVA-MSFE-MSF4",
  ],

  MSF5: [
    "MP-AUX-COM-MSFE-MSF5",
    "MP-AUX-EVA-MSFE-MSF5",
    "MP-REC-EVA-MSFE-MSF5",
  ],

  MSF6: [
    "MP-AUX-L06-MSFE-MSF6",
    "MP-AUX-EVA-MSFE-MSF6",
    "MP-REC-EVA-MSFE-MSF6",
  ],

  MSF7: [
    "MP-AUX-L06-MSFE-MSF7",
    "MP-REC-EVA-MSFE-MSF7",
  ],

  MSF8: [
    "MP-AUX-L06-MSFE-MSF8",
    "MP-REC-EVA-MSFE-MSF8",
  ],

  MSF9: [
    "MP-AUX-L06-MSFE-MSF9",
  ],
};
